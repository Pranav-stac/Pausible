...
export function SubmissionConfirmationScreen({ attemptId }: { attemptId: string }) {
  ...
  return (
    <AppPageShell stepLabel="Step 2 complete" contentClassName="!max-w-7xl !py-8 lg:!py-10">
      ...
      <div className="mt-6 grid gap-6 max-lg:pb-72 lg:mt-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:gap-8 xl:grid-cols-[minmax(0,1fr)_360px] xl:gap-10">
        ...
        {/* Stretch with the answers column so sticky has a tall track to travel on. */}
        <div className="max-lg:contents lg:min-h-0">
          <aside
            className={`${FORM_CARD_CLASS} z-40 p-6 text-left shadow-[0_24px_60px_-28px_rgba(17,24,39,0.28)] sm:p-7 max-lg:fixed max-lg:inset-x-0 max-lg:bottom-0 max-lg:z-50 max-lg:max-h-[min(52vh,28rem)] max-lg:overflow-y-auto max-lg:rounded-b-none max-lg:rounded-t-[22px] max-lg:border-x-0 max-lg:border-b-0 max-lg:shadow-[0_-18px_50px_-20px_rgba(17,24,39,0.35)] lg:sticky lg:top-24 lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto`}
          >
